...
namespace isriding
{
    ...
    {
        private readonly IDbContextProvider<isridingDbContext> _dbContextProvider;
        public SqlExecuter(IDbContextProvider<isridingDbContext> dbContextProvider) { _dbContextProvider = dbContextProvider; }
